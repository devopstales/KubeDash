...
from kubedash.lib.helper_functions import email_check, get_logger
from kubedash.lib.k8s.certificate import k8sCreateUser
from kubedash.lib.k8s.namespace import k8sNamespaceListGet
from kubedash.lib.k8s.security import (k8sClusterRoleBindingAdd,
...
from kubedash.lib.k8s.server import k8sServerContextsList
from kubedash.lib.sso import get_user_token
from kubedash.lib.user import (KubectlConfigStore, Role, SSOGroupsList,
...
def users_privileges_edit():
    if request.method == 'POST':
        ...
        if not bool(user_clusterRole_template_list) or not bool(user_role_template_list):
            from kubedash.lib.k8s import k8sClusterRolesAdd
            k8sClusterRolesAdd()
