...
from lib_functions.registry import RegistryServerCreate, RegistryServerUpdate, RegistryServerDelete, \
    RegistryServerListGet, RegistryGetRepositories, RegistryGetTags, RegistryDeleteTag, RegistryGetManifest, \
    RegistryGetEvent, RegistryEventCreate
