...
from kubespace.lib.helper_functions import email_check, get_logger
    ...
    with k8s_client.ApiClient() as api_client:
        ...
        body = k8s_client.V1CertificateSigningRequest(
            ...
            spec = k8s_client.V1CertificateSigningRequestSpec(
                ...
                signer_name = "kubernetes.io/kubespace-apiserver-client",
                expiration_seconds = 315360000, # 10 years
            ),
        )
    pretty = "true"
    field_manager = 'kubespace'
    try:
...
def k8sApproveUserCSR(username_role, user_token, username):
    ...
    csr_name = "kubespace-user-"+username
    ...
    approval_condition = k8s_client.V1CertificateSigningRequestCondition(
        ...
        message='This certificate was approved by kubespace',
        reason='kubespace',
        type='Approved',
        status='True',
    )
